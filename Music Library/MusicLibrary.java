...
public class MusicLibrary {
    ...
    public void add(Album album) {
        ...
        // I'd throw an exception here (library is full), but we'd have to modify the client class to handle that.
    }
    ...
    // You didn't indicate if remove(1) should remove the 1st or 2nd track (0 or 1-based indexing), so I assumed the first track.
    // Remove the -1 in index - 1 on line 30 if it should have removed the 2nd track instead.
